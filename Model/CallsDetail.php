...
class CallsDetail extends AppModel {
	...
	function afterFind($results) {
		...
		if ((isset($val['CallsDetail']['user_sid']) && ($val['CallsDetail']['user_sid'] != ''))) {
		    $results[$key]['CallsDetail']['user_sid'] = $this->GetNameFromSid($val['CallsDetail']['user_sid']);
		}
	...
	function beforeSave($options) {
	    if (!empty($this->data['CallsDetail']['user_sid'])) {
		    $this->data['CallsDetail']['user_sid'] = $this->GetSidFromName($this->data['CallsDetail']['user_sid']);
	    }
	    return true;
	}
