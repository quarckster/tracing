<div>
	Оставьте свой комментарий по ссылке <a href="http://tracing2/incidents/edit_comment/incident_id:<?php echo $incident['Incident']['id']; ?>/detail_id:<?php echo $detail_id; ?>">http://tracing2/incidents/edit_comment/incident_id:<?php echo $incident['Incident']['id']; ?>/detail_id:<?php echo $detail_id; ?></a>
