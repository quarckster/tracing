...
<div class="row">
	...
	echo $this->Form->input('category', array('class' => 'span2', 'label' => 'Категория', 'div' => array('class' => 'span2'), 'options' => array(null => 'Все', 'Заказ документов' => 'Заказ документов', 'Консультация' => 'Консультация', 'Ошибка' => 'Ошибка')));
	?>
</div>
<!-- <div class="row">
