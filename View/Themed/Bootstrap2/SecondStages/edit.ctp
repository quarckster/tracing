...
<div class="row">
	...
	echo $this->Form->input('SecondStage.category', array('div' => array('class' => 'span2'), 'options' => array('Заказ документов' => 'Заказ документов', 'Ошибка' => 'Ошибка', 'Консультация' => 'Консультация'), 'class' => 'span2', 'label' => 'Способ заказа', 'value' => $this->data['SecondStage']['category']));
	echo $this->Form->input('SecondStage.order_in', array('div' => array('class' => 'span2'), 'options' => array('КЦ' => 'КЦ', 'РХ' => 'РХ', 'Другие РИЦ' => 'Другие РИЦ'), 'class' => 'span2', 'label' => 'Заказ в', 'value' => $this->data['SecondStage']['order_in']));
		...
		<h4>Предварительные ответы</h4>
			<table class="table table-condensed">
				...
				<tr>
					...
					<td><?php echo $this->Form->input('PreliminaryResponse.'. $i .'.delivery', array('class' => 'span2', 'type' => 'text', 'options' => array('Email' => 'email', 'Исх. письмо' => 'Исх. письмо', 'Звонок клиенту' => 'Звонок клиенту', 'СИО' => 'СИО', 'Визит клиента' => 'Визит клиента'), 'type' => 'select', 'label' => false, 'value' => $preliminary_responses['delivery']));?></td>
					...
					<td><?php echo $this->Form->input('PreliminaryResponse.'. $i .'.cis', array('class' => 'span1', 'type' => 'checkbox', 'label' => false, 'value' => $preliminary_responses['cis']));?></td>
...
<div>
	...
	<div class="row">
		...
		echo $this->Form->input('Result.answer_source', array('class' => 'span2', 'label' => 'Источник ответа', 'div' => array('class' => 'span2'), 'options' => array('Архив РИЦ' => 'Архив РИЦ', 'Ведомства по РХ' => 'Ведомства по РХ', 'Другой РИЦ' => 'Другой РИЦ', 'Интернет' => 'Интернет', 'КЦ КП' => 'КЦ КП', 'Корпоративный сервер' => 'Корпоративный сервер', 'Нац. архив' => 'Нац. архив', 'Архив ОРВ РИЦ 188' => 'Архив ОРВ РИЦ 188', 'Официальный сайт' => 'Официальный сайт', 'СПС КП' => 'СПС КП')));
		...
		echo $this->Form->input('Result.delivery', array('div' => array('class' => 'span2'), 'options' => array('Email' => 'email', 'Исх. письмо' => 'Исх. письмо', 'Звонок клиенту' => 'Звонок клиенту', 'СИО' => 'СИО', 'Визит клиента' => 'Визит клиента'), 'class' => 'span2', 'label' => 'Способ передачи', 'value' => $this->data['Result']['delivery']));
		echo $this->Form->input('Result.cis', array('label' => 'Шаблон в КИС', 'div' => array('class' => 'span2'), 'class' => 'span2', 'value' => $this->data['Result']['cis'], 'options' => array(0 => 'Без шаблона', 1 => 'С шаблоном', 2 => 'Шаблон не нужен')));
		?>
	</div>
	<div class="row">
	&nbsp;
