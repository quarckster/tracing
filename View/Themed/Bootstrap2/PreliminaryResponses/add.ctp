...
<div class="row">
	<legend class="span6">Добавить предварительный ответ</legend>
</div>
<div class="row">
	...
	echo $this->Form->input('delivery', array('class' => 'span2', 'label' => 'Способ передачи', 'div' => array('class' => 'span2'), 'options' => array('Email' => 'email', 'Исх. письмо' => 'Исх. письмо', 'Звонок клиенту' => 'Звонок клиенту', 'СИО' => 'СИО', 'Визит клиента' => 'Визит клиента')));?>
</div>
<div class="row">
	&nbsp;
</div>
<div class="row">
	<?php echo $this->Form->input('answer', array('div' => array('class' => 'span6'), 'class' => 'span6', 'label' => 'Ответ', 'type' => 'textarea'))?>
</div>
<div class="row">
	&nbsp;
</div>
